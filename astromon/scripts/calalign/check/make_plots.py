...
def plot_offsets():
    ...
    plot_cxctime(
        SOURCE["date_obs"], SOURCE["dy_old"], ".", markersize=10, color="k", label="old"
    )
    ...
    plot_cxctime(
        SOURCE["date_obs"], SOURCE["dz_old"], ".", markersize=10, color="k", label="old"
    )
    ...
    plt.sca(ax0)
    plot_cxctime(
        [OFFSETS["tstart"][0], OFFSETS["tstop"][-1]], [0, 0], "-", color="tab:orange"
    )
    plot_cxctime(
        SOURCE["date_obs"],
        SOURCE["dy_new"],
