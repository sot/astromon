...
Drops columns that have been retired from the schema:

astromon_xray_src:
    sb_radius          (retired 2026-08: no discriminating power for match quality)
...
# files. These are dropped on migration.
RETIRED_COLUMNS = {
    "astromon_xray_src": {"sb_radius"},
    "astromon_xcorr": set(),
}
